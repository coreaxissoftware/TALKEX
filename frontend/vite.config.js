...
export default defineConfig({
  plugins: [react()],
  // Served from web.talkex.in, whose document root points at this same
  // build output — so it's the ROOT of that origin, not a /talkex/ subpath,
  // and root-absolute asset URLs are correct as-is.
